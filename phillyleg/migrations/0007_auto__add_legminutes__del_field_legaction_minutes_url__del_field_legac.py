...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LegMinutes'
        db.create_table('phillyleg_legminutes', (
            ('url', self.gf('django.db.models.fields.CharField')(max_length=2048, primary_key=True)),
            ('fulltext', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('phillyleg', ['LegMinutes'])

        # Deleting field 'LegAction.minutes_url'
        db.delete_column('phillyleg_legaction', 'minutes_url')

        # Deleting field 'LegAction.minutes_fulltext'
        db.delete_column('phillyleg_legaction', 'minutes_fulltext')
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'LegMinutes'
        db.delete_table('phillyleg_legminutes')

        # Adding field 'LegAction.minutes_url'
        db.add_column('phillyleg_legaction', 'minutes_url', self.gf('django.db.models.fields.CharField')(default='', max_length=2048), keep_default=False)

        # Adding field 'LegAction.minutes_fulltext'
        db.add_column('phillyleg_legaction', 'minutes_fulltext', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)
