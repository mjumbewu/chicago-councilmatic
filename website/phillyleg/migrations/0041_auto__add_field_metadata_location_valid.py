...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MetaData_Location.valid'
        db.add_column('phillyleg_metadata_location', 'valid',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'MetaData_Location.valid'
        db.delete_column('phillyleg_metadata_location', 'valid')
