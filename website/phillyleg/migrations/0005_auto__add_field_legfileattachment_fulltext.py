...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LegFileAttachment.fulltext'
        db.add_column('phillyleg_legfileattachment', 'fulltext', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LegFileAttachment.fulltext'
        db.delete_column('phillyleg_legfileattachment', 'fulltext')
