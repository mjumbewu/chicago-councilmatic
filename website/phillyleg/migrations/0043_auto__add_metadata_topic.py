...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MetaData_Topic'
        db.create_table('phillyleg_metadata_topic', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('topic', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128)),
        ))
        db.send_create_signal('phillyleg', ['MetaData_Topic'])

        # Adding M2M table for field topics on 'LegFileMetaData'
        db.create_table('phillyleg_legfilemetadata_topics', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('legfilemetadata', models.ForeignKey(orm['phillyleg.legfilemetadata'], null=False)),
            ('metadata_topic', models.ForeignKey(orm['phillyleg.metadata_topic'], null=False))
        ))
        db.create_unique('phillyleg_legfilemetadata_topics', ['legfilemetadata_id', 'metadata_topic_id'])

    def backwards(self, orm):
        # Deleting model 'MetaData_Topic'
        db.delete_table('phillyleg_metadata_topic')

        # Removing M2M table for field topics on 'LegFileMetaData'
        db.delete_table('phillyleg_legfilemetadata_topics')
