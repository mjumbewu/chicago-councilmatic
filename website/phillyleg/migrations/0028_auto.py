...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field bookmarks on 'LegFile'
        db.delete_table('phillyleg_legfile_bookmarks')


    def backwards(self, orm):
        
        # Adding M2M table for field bookmarks on 'LegFile'
        db.create_table('phillyleg_legfile_bookmarks', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('legfile', models.ForeignKey(orm['phillyleg.legfile'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('phillyleg_legfile_bookmarks', ['legfile_id', 'user_id'])
