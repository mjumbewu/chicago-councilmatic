...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CouncilMember.title'
        db.add_column('phillyleg_councilmember', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'CouncilMember.title'
        db.delete_column('phillyleg_councilmember', 'title')
