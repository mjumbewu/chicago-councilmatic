...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LegFile.date_scraped'
        db.alter_column('phillyleg_legfile', 'date_scraped', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'LegFile.date_scraped'
        raise RuntimeError("Cannot reverse this migration. 'LegFile.date_scraped' and its values cannot be restored.")
    models = {
