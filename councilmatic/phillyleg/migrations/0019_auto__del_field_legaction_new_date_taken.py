...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'LegAction.new_date_taken'
        db.delete_column('phillyleg_legaction', 'new_date_taken')


    def backwards(self, orm):
        
        # Adding field 'LegAction.new_date_taken'
        db.add_column('phillyleg_legaction', 'new_date_taken', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 7, 27, 13, 57, 45, 533471)), keep_default=False)
