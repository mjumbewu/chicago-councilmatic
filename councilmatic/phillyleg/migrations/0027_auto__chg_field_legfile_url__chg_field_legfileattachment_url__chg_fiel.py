...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LegFile.url'
        db.alter_column('phillyleg_legfile', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'LegFileAttachment.url'
        db.alter_column('phillyleg_legfileattachment', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'LegMinutes.url'
        db.alter_column('phillyleg_legminutes', 'url', self.gf('django.db.models.fields.URLField')(unique=True, max_length=200))


    def backwards(self, orm):
        
        # Changing field 'LegFile.url'
        db.alter_column('phillyleg_legfile', 'url', self.gf('django.db.models.fields.CharField')(max_length=2048))

        # Changing field 'LegFileAttachment.url'
        db.alter_column('phillyleg_legfileattachment', 'url', self.gf('django.db.models.fields.CharField')(max_length=2048))

        # Changing field 'LegMinutes.url'
        db.alter_column('phillyleg_legminutes', 'url', self.gf('django.db.models.fields.CharField')(max_length=2048, unique=True))
