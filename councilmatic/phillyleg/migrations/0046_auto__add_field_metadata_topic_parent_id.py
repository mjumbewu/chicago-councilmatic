...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MetaData_Topic.parent_id'
        db.add_column('phillyleg_metadata_topic', 'parent_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['phillyleg.MetaData_Topic'], null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'MetaData_Topic.parent_id'
        db.delete_column('phillyleg_metadata_topic', 'parent_id_id')
