...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CouncilDistrictPlan'
        db.create_table('phillyleg_councildistrictplan', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('phillyleg', ['CouncilDistrictPlan'])

        # Adding model 'CouncilMemberTenure'
        db.create_table('phillyleg_councilmembertenure', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('councilmember', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tenures', to=orm['phillyleg.CouncilMember'])),
            ('district', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tenures', null=True, to=orm['phillyleg.CouncilDistrict'])),
            ('at_large', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('begin', self.gf('django.db.models.fields.DateField')()),
            ('end', self.gf('django.db.models.fields.DateField')(null=True)),
        ))
        db.send_create_signal('phillyleg', ['CouncilMemberTenure'])

        # Adding model 'CouncilDistrict'
        db.create_table('phillyleg_councildistrict', (
            ('key', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('id', self.gf('django.db.models.fields.IntegerField')()),
            ('shape', self.gf('django.contrib.gis.db.models.fields.PolygonField')()),
            ('plan', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['phillyleg.CouncilDistrictPlan'])),
        ))
        db.send_create_signal('phillyleg', ['CouncilDistrict'])

    def backwards(self, orm):
        # Deleting model 'CouncilDistrictPlan'
        db.delete_table('phillyleg_councildistrictplan')

        # Deleting model 'CouncilMemberTenure'
        db.delete_table('phillyleg_councilmembertenure')

        # Deleting model 'CouncilDistrict'
        db.delete_table('phillyleg_councildistrict')
    ...
    models = {
        ...
        'phillyleg.councilmembertenure': {
            ...
            'district': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tenures'", 'null': 'True', 'to': "orm['phillyleg.CouncilDistrict']"}),
