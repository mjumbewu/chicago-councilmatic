...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LegKeys'
        db.create_table('phillyleg_legkeys', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('continuation_key', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('phillyleg', ['LegKeys'])


    def backwards(self, orm):
        
        # Deleting model 'LegKeys'
        db.delete_table('phillyleg_legkeys')
