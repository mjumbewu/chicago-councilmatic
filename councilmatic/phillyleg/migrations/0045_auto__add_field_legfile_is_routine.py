...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LegFile.is_routine'
        db.add_column('phillyleg_legfile', 'is_routine',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'LegFile.is_routine'
        db.delete_column('phillyleg_legfile', 'is_routine')
