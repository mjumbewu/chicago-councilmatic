...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LegFile.contact'
        db.delete_column('phillyleg_legfile', 'contact')

    def backwards(self, orm):
        # Adding field 'LegFile.contact'
        db.add_column('phillyleg_legfile', 'contact',
                      self.gf('django.db.models.fields.CharField')(default='no contact', max_length=1000),
                      keep_default=False)
