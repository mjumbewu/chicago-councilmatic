...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CouncilMember.headshot'
        db.add_column('phillyleg_councilmember', 'headshot', self.gf('django.db.models.fields.URLField')(max_length=200, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CouncilMember.headshot'
        db.delete_column('phillyleg_councilmember', 'headshot')
