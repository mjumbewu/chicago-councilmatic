...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LegMinutes.date_taken'
        db.add_column('phillyleg_legminutes', 'date_taken', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LegMinutes.date_taken'
        db.delete_column('phillyleg_legminutes', 'date_taken')
